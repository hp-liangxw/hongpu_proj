...
with open(os.path.join(os.path.dirname(__file__), 'ats_concat_parameters_72_1213_sz_dj.pkl'), 'rb') as f:
...
def joint_image(img_list, row_symbol, module_type = 'half', piece_list = [6,6,6,6]):
    """
    去边并水平拼接图像
