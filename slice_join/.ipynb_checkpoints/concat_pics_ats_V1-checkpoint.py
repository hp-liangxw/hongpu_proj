...
with open(os.path.join(os.path.dirname(__file__), 'longi_concat_parameters_60_0730.pkl'), 'rb') as f:
...
def joint_image_1(img_list, row_symbol, module_type = 'half', piece_list = [6,6,6,6]):
    """
    去边并水平拼接图像
